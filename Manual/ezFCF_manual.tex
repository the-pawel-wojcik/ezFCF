...
\item {\tt vg\_formaldehyde.xml}---an input for calculation using vertical gradient approximation. Absorption of the ground state into the first dipole allowed excited singlet in formaldehyde;
