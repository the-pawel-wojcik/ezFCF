...
\ul{make}{xml.py} python script creates an \xml input file for \ezS from several \ai outputs. 
...
\ul{supported.ab}{initio/} folder contains sample input and output files
