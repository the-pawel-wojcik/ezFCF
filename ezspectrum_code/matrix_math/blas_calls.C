/*!
  ...
  Linking blas/lapack libraries: 
  
  IBM: blas and /usr/local/lib/lapack.a 
  
  DEC: dxml
  
  SGI: sgimath

  Revised for greater portability and incorporation into Q-Chem, 
  using the Q-Chem defines UNDERSCORE and CAPS by
  David Sherrill, 17 June 1999.

  AIK, 1998.
*/

#if 1 //comment out if whant to  inline blas calls
